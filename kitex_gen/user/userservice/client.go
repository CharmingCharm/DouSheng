...
type Client interface {
	...
	UpdateUserFollow(ctx context.Context, req *user.UpdateUserFollowRequest, callOptions ...callopt.Option) (r *user.UpdateUserFollowResponse, err error)
}
...
func (p *kUserServiceClient) UpdateUserFollow(ctx context.Context, req *user.UpdateUserFollowRequest, callOptions ...callopt.Option) (r *user.UpdateUserFollowResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
